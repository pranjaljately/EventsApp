...
public class details extends AppCompatActivity implements View.OnClickListener {
    EditText eventname, date, time, event_address;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_time:
                ...
                timePickerDialog = new TimePickerDialog(details.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
...
//                startActivity(i);
    ...
    class SendDataToServer extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL("http://group21flaskaws.eu-west-2.elasticbeanstalk.com/newevent");
    ...
    private void extractJson(String responseJson){
        if(TextUtils.isEmpty(responseJson)){
            ...
            try {
                ...
                Toast.makeText(getApplicationContext(), response, Toast.LENGTH_LONG).show();
                if (response.equalsIgnoreCase("Event Created")) {
